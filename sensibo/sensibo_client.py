...
class SensiboClientAPI(object):
    ...
    def pod_measurement_history(self, podUid):
    ...
    def pod_change_ac_state(self, podUid, currentAcState, propertyToChange, newValue):
        try:
            self._patch("/pods/%s/acStates/%s" % (podUid, propertyToChange), json.dumps({'currentAcState': currentAcState, 'newValue': newValue}))
