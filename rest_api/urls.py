...
router.register(r'depositboxes', views.DepositBoxViewSet, basename='depositbox')
router.register(r'guestcars', views.GuestCarViewSet, basename='guestcars')
router.register(r'vehicle-plates', views.VehiclePlateViewSet, basename='vehicle-plates')
router.register(r'access', views.AccessZoneViewSet, basename='access')
