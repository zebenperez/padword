...
def projects(request, company_id=None, project_id=None):
    try:
        ...
        return render(request, "web/projects-locks/projects.html", {'items':items, 'company': company, 'active': 'projects'})
    except Exception as e:
        print (show_exc(e))
        company = None
        items = Project.objects.all()
        return render(request, "web/projects-locks/projects.html", {'items':items, 'company': company})
...
def projects_search(request):
    try:
        ...
        return render(request, "web/projects-locks/project-list.html", {'items': items, 'company_id': company_id,})
    except Exception as e:
        print (show_exc(e))
